...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/detectree-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13040&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/detectree-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `detectree` can be installed with:

```
conda install detectree
```

It is possible to list all of the versions of `detectree` available on your platform with:
